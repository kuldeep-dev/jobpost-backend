  ...
  <tr style="background:#fff;">
    ...
    <tr>
    	<td style="text-align:center;">  
        	<h1 style="font-size:16px; margin:0;  color:#487697; font-weight:600;">Hi <?php if(isset($order['seller']['name'])){ echo $order['seller']['name']; } ?>,</h1>       
            <h2 style="font-size:12px; margin:0; color:#4a4a4a; font-weight:normal;">Your order #<?php if(isset($order['id'])){ echo $order['id']; } ?> has been cancelled by <?php if(isset($order['user']['name'])){ echo $order['user']['name']; } ?> with below details.</h2>
        </td>
    </tr>

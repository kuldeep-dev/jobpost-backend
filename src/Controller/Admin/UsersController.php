...

{
    ...
    public function enable($id = null) {
        ...
        if ($this->Users->save($user)) {
            ...
            $this->pushnotificationenable($id);
        } else {
    ...
    public function pushnotificationenable($id)
    { 
         $response = array(); 
         if ($this->request->is('post')) { 
          $user_id = $id; 
         ...
         if($userdata['device_token']){  
            $status = 'Yours profile has been activated.';
            $send = $this->SendPushNotificationsAndroid($userdata['device_token'],'Test',$status);
